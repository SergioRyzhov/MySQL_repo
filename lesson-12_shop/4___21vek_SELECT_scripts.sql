...
-- покупательска€ способность, в разрезе пользователей(кол-во продукции в избранном/кол-во купленной продукции из избранного, в %),
...
-- средн€€ дата реализации(рассвет продаж)
...
-- триггеры
-- price_corrector - мен€ет цены на более привлекательные(1.99)
